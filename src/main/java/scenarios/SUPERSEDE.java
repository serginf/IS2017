...
public class SUPERSEDE {
    ...
    public static Dataset getOntology() {
        ...
        // hasAttribute edges
        RDFUtil.addTriple(o, Namespaces.sup.val()+"W1", SourceOntology.HAS_ATTRIBUTE.val(), Namespaces.sup.val()+"D1/lagRatio");
        RDFUtil.addTriple(o, Namespaces.sup.val()+"W1", SourceOntology.HAS_ATTRIBUTE.val(), Namespaces.sup.val()+"D1/VoDMonitorId");
         ...
         */
        OntModel m_w1 = ModelFactory.createOntologyModel();
        RDFUtil.addTriple(m_w1, Namespaces.sup.val()+"InfoMonitor", GlobalOntology.HAS_FEATURE.val(), Namespaces.sup.val()+"LagRatio");
        RDFUtil.addTriple(m_w1, Namespaces.sup.val()+"Monitor", Namespaces.sup.val()+"generatesQoS", Namespaces.sup.val()+"InfoMonitor");
        RDFUtil.addTriple(m_w1, Namespaces.sup.val()+"Monitor", GlobalOntology.HAS_FEATURE.val(), Namespaces.sup.val()+"idMonitor");
        dataset.addNamedModel(Namespaces.sup.val()+"W1",m_w1);
